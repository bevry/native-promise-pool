...
``` typescript
import pkg from 'https://unpkg.com/native-promise-pool@^3.8.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/native-promise-pool/^3.8.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/native-promise-pool@^3.8.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/native-promise-pool@3.8.0'
</script>
```
