...
``` typescript
import pkg from 'https://unpkg.com/native-promise-pool@^3.26.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/native-promise-pool@^3.26.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/native-promise-pool@^3.26.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/native-promise-pool@3.26.0'
</script>
```
...
<ul><li><code>native-promise-pool</code> aliases <code>native-promise-pool/index.cjs</code> which uses the <a href="https://github.com/bevry/editions" title="You can use the Editions Autoloader to autoload the appropriate edition for your consumers environment">Editions Autoloader</a> to automatically select the correct edition for the consumer's environment</li>
